...
def parse_args():
    ...
    parser.add_argument(
        "--input_path", type=str, required=True, help="Path to input image file"
    )
    parser.add_argument(
        "--output_path", type=str, required=True, help="Path to output point cloud file"
    )
