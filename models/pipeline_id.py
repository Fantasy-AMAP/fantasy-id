...
class IDPipeline(DiffusionPipeline):
    ...
    Args:
        ...
        transformer ([`IDTransformer3DModel`]):
            A text conditioned `IDTransformer3DModel` to denoise the encoded video latents.
        scheduler ([`SchedulerMixin`]):
    ...
    def __init__(
        ...
        transformer: Union[IDTransformer3DModel, CogVideoXTransformer3DModel],
